Inside this directory, there is a `routes` directory. Open it up. Take a look at `routes/index.js` (`index.js` is used by Node as the default file in any directory).
